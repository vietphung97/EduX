...
// QUAN TRỌNG: dùng offset +07:00 (giờ VN) — KHÔNG dùng `new Date('2026-07-01')`
// vì JS sẽ parse thành UTC midnight (2026-07-01T00:00:00Z = 07:00 VN), khiến
// tuần bắt đầu lúc 07:00 sáng thay vì 00:00. Hệ quả: XP chơi từ 00:00–07:00 bị
// dồn nhầm sang tuần liền kề → BXH "tuần này" hiển thị sai.
// Theo kế hoạch ESEA 2026 (số 68/2026/KH-ESEA): chương trình 8 tuần từ 01/7
// đến 19/8/2026. 01/07/2026 là Thứ Tư → "tuần chương trình" tính theo chu kỳ
// 7 ngày từ mốc đó (Wed 01/7 → Tue 07/7, …, Wed 12/8 → Tue 18/8 ≈ Week 8).
export const PROGRAM_START_DATE = new Date('2026-07-01T00:00:00+07:00'); // Tuần 1: 01/07 - 07/07/2026 (VN)
...
export const WEEKLY_FRAMES: WeeklyFrame[] = [
  {
    ...
    items: [
      { id: 'w1_a', name: 'Huy hiệu Hộ Chiếu', emoji: '🗺️', xpRequired: 300 },
      { id: 'w1_b', name: 'Viền Khởi Hành', emoji: '🧭', xpRequired: 800 },
      { id: 'w1_c', name: 'Dấu Ấn Phiêu Lưu', emoji: '✨', xpRequired: 1300 },
    ],
  },
  {
    ...
    items: [
      { id: 'w2_a', name: 'Rồng Rừng Xanh', emoji: '🐉', xpRequired: 300 },
      { id: 'w2_b', name: 'Viền Mật Lệnh', emoji: '🌲', xpRequired: 800 },
      { id: 'w2_c', name: 'Bí Ẩn Rừng Sâu', emoji: '🌿', xpRequired: 1300 },
    ],
  },
  {
    ...
    items: [
      { id: 'w3_a', name: 'Tia Chớp Đô Thị', emoji: '⚡', xpRequired: 300 },
      { id: 'w3_b', name: 'Viền Thành Phố', emoji: '🏙️', xpRequired: 800 },
      { id: 'w3_c', name: 'Phiêu Lưu Ký', emoji: '🗼', xpRequired: 1300 },
    ],
  },
  {
    ...
    items: [
      { id: 'w4_a', name: 'Cá Voi Đại Dương', emoji: '🐋', xpRequired: 300 },
      { id: 'w4_b', name: 'Viền Vực Sâu', emoji: '🌊', xpRequired: 800 },
      { id: 'w4_c', name: 'Bí Ẩn Đáy Biển', emoji: '🐙', xpRequired: 1300 },
    ],
  },
  {
    ...
    items: [
      { id: 'w5_a', name: 'Đại Bàng Đỉnh Núi', emoji: '🦅', xpRequired: 300 },
      { id: 'w5_b', name: 'Viền Chinh Phục', emoji: '⛰️', xpRequired: 800 },
      { id: 'w5_c', name: 'Đỉnh Cao Tuyệt Vời', emoji: '🏔️', xpRequired: 1300 },
    ],
  },
  {
    ...
    items: [
      { id: 'w6_a', name: 'Mặt Trời Sa Mạc', emoji: '☀️', xpRequired: 300 },
      { id: 'w6_b', name: 'Viền Băng Qua', emoji: '🏜️', xpRequired: 800 },
      { id: 'w6_c', name: 'Chiến Binh Sa Mạc', emoji: '🐪', xpRequired: 1300 },
    ],
  },
  {
    ...
    items: [
      { id: 'w7_a', name: 'Dù Trời Mây', emoji: '🪂', xpRequired: 300 },
      { id: 'w7_b', name: 'Viền Đảo Trên Mây', emoji: '🏝️', xpRequired: 800 },
      { id: 'w7_c', name: 'Bay Tự Do', emoji: '🌤️', xpRequired: 1300 },
    ],
  },
  {
    ...
    items: [
      { id: 'w8_a', name: 'Tàu Vũ Trụ', emoji: '🛸', xpRequired: 300 },
      { id: 'w8_b', name: 'Viền Thiên Hà', emoji: '🚀', xpRequired: 800 },
      { id: 'w8_c', name: 'Du Hành Giữa Sao', emoji: '🌌', xpRequired: 1300 },
    ],
  },
];
